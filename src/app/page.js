...
export default function Landing() {
  ...
  const productMenu = [
    { t: "AI Business Scanner", d: "Score your AI readiness", action: () => scrollTo("features") },
    { t: "Implementation Blueprints", d: "Step-by-step AI plans", action: () => scrollTo("features") },
    { t: "AI Agent Builder", d: "Build & deploy chatbots", action: () => scrollTo("features") },
    { t: "Embed & API", d: "Add AI to your website", action: () => scrollTo("features") },
  ];
  const solutionsMenu = [
    { t: "Retail & E-commerce", d: "Orders, replies, inventory", action: () => scrollTo("use-cases") },
    { t: "Services & Agencies", d: "Reporting & client comms", action: () => scrollTo("use-cases") },
    { t: "Healthcare", d: "Appointments & queries", action: () => scrollTo("use-cases") },
    { t: "Manufacturing", d: "Scheduling & forecasting", action: () => scrollTo("use-cases") },
  ];
  const resourcesMenu = [
        ...
        <nav className="sticky top-0 z-50 bg-[#0a0a0f]/80 backdrop-blur border-b border-white/5">
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-1">
              {/* Product */}
              <div className="relative" onMouseEnter={() => setDropdown("product")} onMouseLeave={() => setDropdown(null)}>
              ...
              {/* Docs */}
              <button onClick={() => nav("/docs")} className="px-3 py-2 text-sm text-slate-300 hover:text-white transition">Docs</button>
              {/* Pricing */}
              <button onClick={() => nav("/pricing")} className="px-3 py-2 text-sm text-slate-300 hover:text-white transition">Pricing</button>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-10">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-slate-400">
                  <button onClick={() => scrollTo("features")} className="block hover:text-white transition">Features</button>
                  <button onClick={() => nav("/pricing")} className="block hover:text-white transition">Pricing</button>
                  <button onClick={() => nav("/demo")} className="block hover:text-white transition">Live Demo</button>
                  <button onClick={() => nav("/docs")} className="block hover:text-white transition">Docs</button>
                </div>
              </div>
              <div>
                <p className="text-sm font-semibold mb-3">Company</p>
                <div className="space-y-2 text-sm text-slate-400">
                  <button onClick={() => nav("/contact")} className="block hover:text-white transition">Contact</button>
                  <button onClick={() => scrollTo("use-cases")} className="block hover:text-white transition">Solutions</button>
                </div>
              </div>
              <div>
                <p className="text-sm font-semibold mb-3">Legal</p>
                <div className="space-y-2 text-sm text-slate-400">
                  <button onClick={() => nav("/privacy")} className="block hover:text-white transition">Privacy</button>
                  <button onClick={() => nav("/terms")} className="block hover:text-white transition">Terms</button>
                </div>
              </div>
            </div>
